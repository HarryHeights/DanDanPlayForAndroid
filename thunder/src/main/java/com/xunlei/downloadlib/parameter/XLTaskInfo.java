...
public class XLTaskInfo implements Parcelable {
    ...
    public String mSourceUrl;   //下载地址
    public String mSaveFolder;  //种子保存文件夹
    public int[] mIndexes;   //文件选择列表
    ...
    public XLTaskInfo(Parcel parcel) {
        ...
        parcel.readIntArray(this.mIndexes);
    }
}
